...
public class PlanoDeEnsinoObjetivoEspecificoPanel extends DefaultFieldsPanel {
    ...
    public PlanoDeEnsinoObjetivoEspecificoPanel() {
    ...
    private void initComponents() {
        ...
        add(panelEspecificos(), BorderLayout.PAGE_START);
...
//        objetivoEspecificoScroll.setPreferredSize(new Dimension(700, 200));
        ...
        return objetivoEspecificoScroll;
    }
    ...
    private class ObjetivoActionListener implements ActionListener {
        ...
        public ObjetivoActionListener() {
            try {
                col = ControllerFactory.createObjetivoController();
            } catch (Exception ex) {
                Logger.getLogger(PlanoDeEnsinoObjetivoEspecificoPanel.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (source == btUpdate && isValidated()) {
                ...
                try {
                    ...
                    Objetivo o = objetivoTableModel.getRow(selectedRow);
                    col.remover(o);
