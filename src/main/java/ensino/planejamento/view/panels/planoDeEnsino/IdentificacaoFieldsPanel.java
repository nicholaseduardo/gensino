 ...
 * @author nicho
 */
public class IdentificacaoFieldsPanel extends DefaultFieldsPanel {
    ...
    public IdentificacaoFieldsPanel() {
        this(null);
    }

    public IdentificacaoFieldsPanel(UnidadeCurricular unidadeCurricular) {
        super();
    ...
    public void setFieldValues(Object object) {
        if (object instanceof PlanoDeEnsino) {
            ...
            comboCampus.setSelectedItem(curso.getCampus());
            PeriodoLetivo periodoLetivo = plano.getPeriodoLetivo();
