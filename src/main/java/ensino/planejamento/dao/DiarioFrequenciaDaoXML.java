...
public class DiarioFrequenciaDaoXML extends AbstractDaoXML<DiarioFrequencia> {
    ...
    protected DiarioFrequencia createObject(Element e, Object ref) {
        try {
            ...
            Integer diarioId = Integer.parseInt(e.getAttribute("diarioId")),
    ...
    public List<DiarioFrequencia> list(Diario diario) {
        PlanoDeEnsino planoDeEnsino = diario.getId().getPlanoDeEnsino();
    ...
    public void save(DiarioFrequencia o) {
        Diario diario = o.getId().getDiario();
        PlanoDeEnsino planoDeEnsino = diario.getId().getPlanoDeEnsino();
        ...
        Integer campusId = curso.getId().getCampus().getId(),
                ...
                unidadeId = und.getId().getId(), planoId = planoDeEnsino.getId();

        if (o.getId()== null) {
            o.getId().setId(nextVal(diario.getId(), planoId, unidadeId, cursoId,campusId));
        }
