...
public class ObjetivoDetalheDaoXML extends AbstractDaoXML<ObjetivoDetalhe> {
    ...
    public ObjetivoDetalheDaoXML(URL url) throws IOException, ParserConfigurationException, TransformerException {
        super("objetivoDetalhe", url, "ObjetivoDetalhe", "objetivoDetalhe", ObjetivoDetalheFactory.getInstance());
    }
    ...
    public void save(ObjetivoDetalhe o) {
        ...
        if (o.isDeleted()) {
            ...
            String filter = String.format("@objetivoSequencia=%d and @detalhamentoSequencia=%d and @planoDeEnsinoId=%d and @unidadeCurricularId=%d and @cursoId=%d and @campusId=%d",
                    o.getId().getObjetivo().getId().getSequencia(), detalhamentoSeq, planoId, undId, cursoId, campusId);
            super.save(o, filter);
        }
    }
