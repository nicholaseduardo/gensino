...
public class AvaliacaoDaoXML extends AbstractDaoXML<Avaliacao> {
    ...
    public void save(Avaliacao o) {
        ...
        PlanoAvaliacao planoAvaliacao = o.getId().getPlanoAvaliacao();
        Integer planoId = planoAvaliacao.getId().getPlanoDeEnsino().getId(),
                planoAvaliacaoSeq = planoAvaliacao.getId().getSequencia(),
                undId = planoAvaliacao.getId().getPlanoDeEnsino().getUnidadeCurricular().getId().getId(),
                cursoId = planoAvaliacao.getId().getPlanoDeEnsino().getUnidadeCurricular().getId().getCurso().getId().getId(),
                campusId = planoAvaliacao.getId().getPlanoDeEnsino().getUnidadeCurricular().getId().getCurso().getId().getCampus().getId();
        ...
        String filter = String.format("@estudanteId=%d and @planoAvaliacaoSequencia=%d and @planoDeEnsinoId=%d and @unidadeCurricularId=%d and @cursoId=%d and @campusId=%d",
                o.getId().getEstudante().getId(), planoAvaliacaoSeq, planoId, undId, cursoId, campusId);
        super.save(o, filter);
    }
