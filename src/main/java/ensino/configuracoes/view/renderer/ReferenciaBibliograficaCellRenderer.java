...
public class ReferenciaBibliograficaCellRenderer extends GenCellRenderer {
    ...
    public Component getTableCellRendererComponent(JTable table, Object value,
        ...
        GenJLabel lblAutor = createLabel(o.getId().getBibliografia().getAutor());

        GenJLabel lblTitulo = createLabel(String.format("[Título: %s]", o.getId().getBibliografia().getTitulo()));
