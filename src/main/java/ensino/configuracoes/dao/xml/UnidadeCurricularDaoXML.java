...
public class UnidadeCurricularDaoXML extends AbstractDaoXML<UnidadeCurricular> {
    ...
    public UnidadeCurricularDaoXML(URL url) throws IOException, ParserConfigurationException, TransformerException {
        super("unidadeCurricular", url, "UnidadeCurricular", "unidadeCurricular", UnidadeCurricularFactory.getInstance());
    }
