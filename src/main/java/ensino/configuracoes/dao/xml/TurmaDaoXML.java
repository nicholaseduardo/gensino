...
public class TurmaDaoXML extends AbstractDaoXML<Turma> {
    ...
    public TurmaDaoXML(URL url) throws IOException, ParserConfigurationException, TransformerException {
        super("turma", url, "Turma", "turma", TurmaFactory.getInstance());
    }
    ...
    public void save(Turma o) {
        ...
        if (o.getId() == null) {
            o.getId().setId(this.nextVal(campusId, cursoId));
        }
        // cria a expressão de acordo com o código do campus
