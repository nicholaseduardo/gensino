...
public class CalendarioDaoXML extends AbstractDaoXML<Calendario> {
    ...
    public CalendarioDaoXML(URL url) throws IOException, ParserConfigurationException, TransformerException {
        super("calendario", url, "Calendario", "calendario", CalendarioFactory.getInstance());
    }
    ...
    public void save(Calendario o) {
        ...
        String filter = String.format("@ano=%d and @campusId=%d",
                o.getId().getAno(), o.getId().getCampus().getId());
        super.save(o, filter);
    }
