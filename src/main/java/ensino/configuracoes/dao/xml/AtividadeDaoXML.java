...
public class AtividadeDaoXML extends AbstractDaoXML<Atividade> {
    ...
    public AtividadeDaoXML(URL url) throws IOException, ParserConfigurationException, TransformerException {
        super("atividade", url, "Atividade", "atividade", AtividadeFactory.getInstance());
    }
    ...
    public void save(Atividade o) {
        ...
        if (o.getId().getId() == null) {
            o.getId().setId(this.nextVal(ano, campusId));
        } 
