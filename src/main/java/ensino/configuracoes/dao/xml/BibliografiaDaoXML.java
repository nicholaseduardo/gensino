...
public class BibliografiaDaoXML extends AbstractDaoXML<Bibliografia> {
    ...
    public BibliografiaDaoXML(URL url) throws IOException, ParserConfigurationException, TransformerException {
        super("bibliografia", url, "Bibliografia", "bibliografia", BibliografiaFactory.getInstance());
    }
