...
public class ReferenciaBibliograficaDaoXML extends AbstractDaoXML<ReferenciaBibliografica> {
    ...
    public ReferenciaBibliograficaDaoXML(URL url) throws Exception {
        super("referenciaBibliografica", url, "ReferenciaBibliografica", "referenciaBibliografica",
                ReferenciaBibliograficaFactory.getInstance());
    }
