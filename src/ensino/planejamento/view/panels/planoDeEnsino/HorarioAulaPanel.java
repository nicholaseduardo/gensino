        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (source == btAdd) {
                if (isValidated()) {
                    ...
                    if (sId.matches("\\d")) {
                        horarioAula.setId(Integer.parseInt(sId));
                    }
                    ...
                    if (selectedRow < 0) {
                        ...
                        HorarioAula old = (HorarioAula) horarioAulaTableModel.getRow(selectedRow);
                        horarioAula.setId(old.getId());
