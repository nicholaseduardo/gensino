...
public class PlanoDeEnsinoPanelFields extends DefaultFieldsPanel {
    ...
    private IdentificacaoPanel identificacaoPanel;
    ...
    private void initComponents() {
        ...
        identificacaoPanel = new IdentificacaoPanel(selectedUnidadeCurricular);
    ...
    public HashMap<String, Object> getFieldValues() {
        ...
        for(int i = 0; i < lPlanosAvaliacoes.size(); i++) {
            ...
            for(int j = 0; j < lAvaliacoes.size(); j++) {
                 ...
                 */
                if (planoAvaliacao.equals(avaliacao.getPlanoAvaliacao())) {
    ...
    public boolean isValidated() {
        ...
        } else if (!objetivoEspecificoPanel.isValidated()) {
            treePlanoDeEnsino.setSelectionRow(TabsPlano.ESP.toInt());
            objetivoEspecificoPanel.initFocus();
        } else {
            return true;
        }
        return false;
