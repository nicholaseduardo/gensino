...
public class CalendarioFields extends DefaultFieldsPanel {
    ...
    public void setFieldValues(Object object) {
        ...
        if (object instanceof Calendario) {
            ...
            comboCampus.setSelectedItem(calendario.getCampus());
    ...
    public void enableFields(boolean active) {
        ...
        // variável criada para garantir o preenchimento após o cadastro do calendario
        boolean activeSearch = active && !"".equals(txtAno.getText());
        atividadePanel.enableFields(activeSearch);
        periodosLetivosPanel.enableFields(activeSearch);
        semanaLetivaPanel.enableFields(activeSearch);
        btGenSemanas.setEnabled(activeSearch);
    }
