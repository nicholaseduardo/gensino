...
public final class FileHelper {
     ...
     * @param fileType  Definição da extensão do arquivo (jpg,png,jpeg)
     * @return 
     */
    public static JFileChooser loadFileChooser(int type, int fileType) {
        ...
        switch (fileType) {
            case FILE_TYPE_JPG:
                ...
                filter = new FileNameExtensionFilter("Arquivos JPG", "jpg", "Formato JPG");
                break;
            case FILE_TYPE_PNG:
                // Criando filtro para selecionar somente arquivos deste programa SPX.
            ...
            default:
                // Criando filtro para selecionar somente arquivos deste programa SPX.
                filter = new FileNameExtensionFilter("Arquivos JPEG", "jpeg", "Imagem JPEG");
                break;
        }
